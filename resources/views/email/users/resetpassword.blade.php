						...
						<tr>
                            ...
                            <!-- Start Space -->
								...
								<!-- Section 1 Starts / Logo social ================  -->
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" bgcolor="#FAFAE2">
									<tbody>
										<tr>
											<td height="26">&nbsp;</td>
										</tr>
										<tr>
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															 <td align="center"><img src="https://acmetrader.club/./assets/home/img/Asset_7.png"  height="70" alt="masterphotonetwork logo"/></td>
																				...
																				<tbody>
																					...
																					<tr >
																						<td style="font-size:12px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							<hr />
																							หากไม่สามารถกดปุ่ม “Reset Password” ได้ คุณสามารถ copy และ paste URL ข้างล่างในบราวเซอร์ได้ <a href="{{$url}}">{{$url}}</a>.</td>
																					</tr>
                                                                                    <tr>
																						<td height="30">&nbsp;</td>
																					</tr>
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2019 acmetrader.club</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
