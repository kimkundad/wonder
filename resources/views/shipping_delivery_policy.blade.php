          ...
          <div class="theme-payment-page-sections-item">
            <div class="theme-payment-page-signin">
              ...
              <div class="theme-payment-page-signin-body">
                <h4 class="theme-payment-page-signin-title">Shipping & Delivery Policy</h4>
          ...
          <div class="theme-payment-page-sections-item">
            <div class="theme-search-results-item theme-payment-page-item-thumb">
              <div class="row" data-gutter="20">
                ...
                <div class="col-md-12 ">
                  <h3 class="theme-payment-page-form-title">การซื้อสินค้าและการจัดส่งสินค้า</h3>
                  <h3 class="theme-payment-page-form-title">ขั้นตอนการสั่งซื้อสินค้า</h3>
                  <p class="theme-payment-page-signin-subtitle">ท่านสามารถสั่งซื้อสินค้าได้จากช่องทางดังนี้</p>
                  <br />
                  ...
                  <h3 class="theme-payment-page-form-title">สั่งซื้อผ่านระบบออนไลน์</h3>
                  ...
                  <h3 class="theme-payment-page-form-title">เงื่อนไขการยกเลิกคำสั่งซื้อ</h3>
                  <p class="theme-payment-page-signin-subtitle">– ท่านสามารถยกเลิกธุรกรรมการสั่งซื้อได้ก่อนการทำการโอนชำระค่าสินค้าเท่านั้น</p>
                  <br />

                  <h3 class="theme-payment-page-form-title">การแจ้งยกเลิกคำสั่งซื้อ</h3>
                  ...
                  <h3 class="theme-payment-page-form-title">นโยบายการชำระเงิน</h3>
                  ...
                  <br />
                  <p class="theme-payment-page-signin-subtitle">1. ช่องทางการชำระเงิน</p>
                  <br />
                  ...
                  <p class="theme-payment-page-signin-subtitle">2. ยืนยันการชำระเงิน</p>
                  <br />
                  ...
                  <br />
                  <p class="theme-payment-page-signin-subtitle">3. เจ้าหน้าที่ยืนยันการรับชำระเงิน</p>
                  <br />
                  ...
                  <h3 class="theme-payment-page-form-title">นโยบายการจัดส่งสินค้า</h3>
                  <p class="theme-payment-page-signin-subtitle">เงื่อนไขการจัดส่งสินค้า</p>
                  <br />
                  ...
                  <h3 class="theme-payment-page-form-title"> ช่องทางการจัดส่งสินค้า</h3>
                  ...
                  <h3 class="theme-payment-page-form-title"> เงื่อนไขการรับผิดชอบในการจัดส่งสินค้า</h3>
                  ...
                  <h3 class="theme-payment-page-form-title"> นโยบายการคืนสินค้า / เปลี่ยนสินค้า</h3>
                  ...
                  <h3 class="theme-payment-page-form-title"> เงื่อนไขการคืนเงิน/เปลี่ยนสินค้า</h3>
                  ...
                  <br />
                  <p class="theme-payment-page-signin-subtitle"><b>ในกรณีที่ไม่รับคืนหรือเปลี่ยนสินค้า</b> </p>
                  <br />
