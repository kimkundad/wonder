          ...
          <div class="theme-payment-page-sections-item">
            <div class="theme-payment-page-signin">
              ...
              <div class="theme-payment-page-signin-body">
                <h4 class="theme-payment-page-signin-title">Returns & Exchanges</h4>
          ...
          <div class="theme-payment-page-sections-item">
            <div class="theme-search-results-item theme-payment-page-item-thumb">
              <div class="row" data-gutter="20">
                ...
                <div class="col-md-12 ">
                  <h3 class="theme-payment-page-form-title">นโยบายการซื้อสินค้า</h3>
                  ...
                  <h3 class="theme-payment-page-form-title">ยืนยันการชำระเงิน</h3>
                  ...
                  <h3 class="theme-payment-page-form-title">เจ้าหน้าที่ยืนยันการรับชำระเงิน</h3>
                  ...
                  <h3 class="theme-payment-page-form-title">เงื่อนไขการจัดส่งสินค้า</h3>
